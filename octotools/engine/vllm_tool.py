...
class ChatToolVLLM(EngineLM, CachedEngine):
    ...
    def __init__(
        ...
        **kwargs):
        ...
        print(f"Using Agent VLLM {self.model_string} backend")
        try:
            self.client = OpenAI(
    ...
    def _generate_text(
        self, messages, temperature=0, max_tokens=4000, top_p=0.99, response_format=None
    ):
