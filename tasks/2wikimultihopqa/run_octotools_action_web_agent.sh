...
############
LABEL="octotools_gpt-4o_action_tool-n1_web_agent_qwen2.5-7b-instruct"
LLM="gpt-4o"
export ACTION_LLM="action-ZhuofengLi/tool-n1-reason-lora-sft-800-step"
TOOL_LLM="agent-qwen2.5-7B-instruct"
ENABLED_TOOLS="Web_Agent_Tool"
...
indices=($(seq 0 199)) # TODO: update here
